...
return {
      ...
      vim.g.rustaceanvim = {
        ...
        server = {
          on_attach = function(client, bufnr)
            ...
            map("<leader>ra", function() vim.cmd.RustLsp("codeAction") end,    "Code action (Rust)")
            map("K",          function() vim.cmd.RustLsp({ "hover", "actions" }) end, "Hover / Docs")
          end,
  ...
  -- ── Cargo.toml dependency helper ────────────────────────
  {
    ...
    keys = {
      { "<leader>ct",  function() require("crates").toggle() end,             ft = "toml", desc = "Toggle crate info" },
      { "<leader>cr",  function() require("crates").reload() end,             ft = "toml", desc = "Reload crates" },
      ...
      { "<leader>cd",  function() require("crates").show_dependencies_popup() end, ft = "toml", desc = "Crate deps" },
